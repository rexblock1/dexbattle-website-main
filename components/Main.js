        ...
        <div className='mt-6 left-[40px] absolute flex flex-col'>
          ...
          <div className='flex flex-row items-center text-start'>
            <div className='mr-6  border-b-4 border-brand-yellow'>
                ...
                <h1 className='text-[25px] mt-8 font-kanit border-2 border-red-700 rounded-md px-4 py-2 font-medium text-white'>📢 We launch DexBattle {'(Beta)'} on 25<sup>th</sup> Jan 2023</h1>
            ...
            <a href={social.googlePlayStore}><div class="flex items-center border rounded-lg px-4 py-2 w-52 mx-2 my-2">
                ...
                <a href='/game.exe' download='/game/DexBattle.exe'><div class="flex items-center border rounded-lg px-4 py-2 w-52 mx-2 my-2">
